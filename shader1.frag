...
vec4 convertedData = iData*vec4(96.0, 4.0, 32.0, 32.0);
vec4 convertedData2 = convertedData+vec4(4.0, 4.0, 0.0, 0.0);
...
void main()
{
    ...
    uv=uv/convertedData2.x+.5; // HERE x 4.0
    uv-=iMouse.xy/iResolution.xy/convertedData2.y; // HERE y 4.0
